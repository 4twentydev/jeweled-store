...
const CATEGORY_MATERIALS: Record<string, string> = {
    "bejeweled-lighters":
        "Hand-applied rhinestones over a refillable metal lighter body.",
    ...
    "custom-rhinestone-items":
        "Materials vary by commission and are confirmed before quoting.",
};
...
const ITEMS = [
    {
        ...
        content: (category: string) =>
            ...
            "Hand-applied crystal detailing over a premium accessory.",
    },
    {
        title: "Dimensions",
        content: () =>
    ...
    },
    {
        ...
        content: () =>
            "Crafted for daily use, so if dropping things is your thing fear not, plus, we use a water resistent glue so getting wet isnt a problem. ",
    },
];
