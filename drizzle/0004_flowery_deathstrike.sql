...
CREATE INDEX "custom_request_attempts_ip_at_idx" ON "custom_request_attempts" USING btree ("ip","attempted_at");--> statement-breakpoint
...
CREATE INDEX "product_reservation_expiry_idx" ON "product_reservations" USING btree ("expires_at");